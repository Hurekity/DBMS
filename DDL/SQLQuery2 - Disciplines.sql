...
--(
--   discipline SMALLINT NOT NULL CONSTRAINT FK_DisciplinesDirectionsRealtion_Disciplines FOREIGN KEY REFERENCES Disciplines (discipline_id),
...
--	CONSTRAINT FK_RequiredDiscipline_Disciplines 
--	FOREIGN KEY REFERENCES Disciplines (discipline_id),
...
--	CONSTRAINT FK_DependentDiscipline_Disciplines
--	FOREIGN KEY REFERENCES Disciplines (discipline_id),
...
--CREATE TABLE TeacherDicsiplineRelation
--(
